...
# Aqui você precisará substituir os campos vazios pelos detalhes do seu aplicativo KeyAuth
keyauthapp = api(
    name="PrefireScript",
    ownerid="INgrvPEN4z",
...
entry1_var = customtkinter.StringVar(value='username')
entry1 = customtkinter.CTkEntry(master=frame, placeholder_text="Usuário", textvariable=entry1_var)
entry1.pack(pady=12, padx=10)

entry2_var = customtkinter.StringVar(value='userpassw')
entry2 = customtkinter.CTkEntry(master=frame, placeholder_text="Senha", textvariable=entry2_var)
entry2.pack(pady=12, padx=10)

entry3_var = customtkinter.StringVar(value='userkey')
entry3 = customtkinter.CTkEntry(master=frame, placeholder_text="Key", textvariable=entry3_var)
entry3.pack(pady=12, padx=10)

register_button = customtkinter.CTkButton(master=frame, text="Registrar", command=register)
...
label_1 = customtkinter.CTkLabel(master=frame, justify=customtkinter.LEFT, text="Atenção! Para logar, apenas o usuario e a senha são necessários.")
